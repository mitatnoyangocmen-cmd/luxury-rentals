...
- Accommodations: 150m² private floor, 4 private bedrooms, sleeps up to 10 guests. No shared areas. Highly secure.
  - Bedroom 1: King Bed, private in-suite glass jacuzzi tub.
  - Bedroom 2: Queen Bed.
  - Bedroom 3: 2 Twin Beds.
  - Bedroom 4: Twin bunk bed + high-end sofa bed in lounge.
- Luxury Amenities: Rooftop panoramic terrace with Bosphorus/Sultanahmet view, private master jacuzzi tub, 120-inch dropdown home cinema projector (with surround audio), 3 powerful modern AC units, electric fireplace, laundry closet (washer + steam iron), barista coffee maker, double kitchens.
...
- House Rules: No indoor smoking (permitted on open rooftop terrace), no massive loud parties, no pets. Standard check-in is 3:00 PM, checkout is 11:00 AM. Contactless check-in via smart digital door lock code (provided 24 hours prior to arrival).
