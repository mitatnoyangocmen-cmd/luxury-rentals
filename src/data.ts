...
export const INITIAL_REVIEWS: Review[] = [
  {
    ...
    author: 'Hafsa Foodey',
    rating: 5,
    text: 'Mitat and Feyza were lovely hosts from start to finish! The house was clean, comfortable and really homely, with everything we needed to feel right at home. They were always responsive and helpful whenever we needed anything.\n\nThe location was also great, with easy access to all the main transport options and everything you need nearby. We had a really lovely stay and would definitely recommend them and stay again!',
  ...
  },
  {
    ...
    author: 'Nada Gourari',
    rating: 5,
    text: 'It was an amazing experience with a great big apartment. We were 3 families and there were plenty of space to sit, sleep and move around. The apartment is on the 4th floor so you really get a workout in but it was no problem for any of us. We would book it again. The host was always available at any time and was very very helpful and nice. They would answer within seconds and would offer to be there to help if anything went off. A big thanks to the hosts 🙏',
    country: 'Denmark 🇩🇰',
    date: '',
    avatar: 'NG',
    platform: 'Airbnb',
  },
  {
    ...
    author: 'Ellie Xiong',
    rating: 5,
    text: 'The location of the apartment is very convenient, with plenty of supermarkets and convenience stores nearby, making it very easy to buy anything you need. There is a ŞOK supermarket just around the corner, a bus stop and ATM right downstairs, and a metro station only about 100 meters away. We stayed for two nights and were very comfortable, and getting around was very easy.\n\nThe apartment is on the 4th floor and there is no elevator, so you will need to carry your luggage upstairs. The host was especially kind. Our flight was quite late, and he kindly let us store our luggage in the apartment after check-out, until 3 PM.',
    country: 'China 🇨🇳',
    date: '',
    avatar: 'EX',
    platform: 'Airbnb',
  ...
  {
    id: 'rev-6',
    author: 'Zakariya Mehdi',
    rating: 5,
    text: 'Mitat was a great host, he answered all queries and did so in a timely manner.\n\nThe apartment itself was exactly as described, clean, cool & spacious - the large screen projector and AC were great features.\n\nThe location of the apartment was excellent, there is a tram stop across the road that takes you to the Hagia Sophia & Blue Mosque in under 10 minutes, there is a row of ATM machines directly outside and at the bottom of the building there is a cafe open until late.\n\nWithin a 10 minute walk from the apartment there are dozens of 24/7 restaurants, cafes and stores, with our personal favourite being Yusufpasa Baked Goods (we found this in the guide provided by Mitat in the apartment). At Yusufpasa Baked Goods the breakfast, food & dessert options were great and the staff were extremely friendly to the point we visited multiple times a day.\n\nThis was my 4th time in Istanbul and all things considered this was by far the best Airbnb/hotel I have stayed in.',
    country: 'United Kingdom 🇬🇧',
    date: '',
    avatar: 'ZM',
    platform: 'Airbnb',
  },
  {
    ...
    author: 'Fatima Zahra',
    rating: 5,
    text: 'I booked Mitat’s Airbnb for a family trip with my in-laws and I couldn’t be more satisfied with it. Mitat has been very helpful, extremely proactive and available throughout our stay. The apartment itself is very comfortable and has all the necessary amenities and more. I recommend it 1000%!',
    country: 'France 🇫🇷',
    date: '',
    avatar: 'FZ',
    platform: 'Airbnb',
  ...
  {
    id: 'rev-10',
    author: 'Sofia Levenkova',
    rating: 5,
    text: 'We really liked this apartment for its price. The owner was always available and answered us at any time. The apartment is located in an old district of Istanbul. There’s a tram stop nearby — it’s 10 minutes to the city center. There’s also an exchange office with a good rate close by, right across the street. Grocery stores, restaurants, and cafes for any budget are within walking distance. The view from the balcony is wonderful. We really liked this apartment.',
    country: 'Russia 🇷🇺',
    date: '',
    avatar: 'SL',
  ...
  },
  {
    ...
    author: 'Buwen Liu',
    rating: 5,
    text: 'The apartment was fantastic; it comfortably accommodated all eight of us. The location was convenient, close to public transportation, and the apartment was very clean and felt right at home. We even cooked in the apartment, which was a completely different experience from staying in a traditional hotel.',
    country: 'China 🇨🇳',
    date: '',
    avatar: 'BL',
    platform: 'Booking.com',
  ...
  {
    id: 'rev-4',
    author: 'Gemma Hutchison',
    rating: 5,
    text: 'Good value for money. Great location close to public transport with plenty of restaurants nearby. Lovely space and view from deck/window. Everything we needed was provided in a well-stocked kitchen.',
    country: 'Australia 🇦🇺',
    date: '',
    avatar: 'GH',
    platform: 'Airbnb',
  ...
  {
    id: 'rev-5',
    author: 'Mohamed Elmusharaf',
    rating: 5,
    text: 'As advertised, near all the attractions by train. Great views, plenty of local food around, and close to the train, bus and Uber pickup locations.',
    country: 'Canada 🇨🇦',
    date: '',
    avatar: 'ME',
    platform: 'Airbnb',
  ...
  {
    id: 'rev-7',
    author: 'Nadia Gourari',
    rating: 5,
    text: 'Clean, bright and well-ventilated apartment. Simple, chic and effective decoration. Excellent location. Very good quality bedding. The view is simply magnificent. The host was attentive and responsive. Highly recommended.',
    country: 'France 🇫🇷',
    date: '',
    avatar: 'NG',
    platform: 'Airbnb',
  },
  {
    ...
    author: 'Martin Grimm',
    rating: 5,
    text: 'We would book this accommodation again at any time! Everything was very clean. Everything was within a short walking distance or easily accessible by public transport. Communication with Mitat was very quick, uncomplicated and very friendly. Thank you very much to Mitat for the wonderful time!',
    country: 'Germany 🇩🇪',
    date: '',
    avatar: 'MG',
    platform: 'Airbnb',
